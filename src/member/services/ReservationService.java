...
public class ReservationService {
    ...
    public List<ScreenDto> getScreenMovie() throws SQLException {
        List<ScreenDto> list = new ArrayList<>();
        String sql = "select s_id,start_time,current_capacity,t_id from Screen where start_time > NOW()";
...
//        form.setUser_id(user_id);
        ...
        ScreenDto checkForm = new ScreenDto(); // 남은좌석등을 확인할 form
